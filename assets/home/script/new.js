...
function initLearnerSlider() {
  ...
  const prevBtn    = document.getElementById("learnerPrev"); // â† add
  const nextBtn    = document.getElementById("learnerNext"); // â† add
...
function initVideoSection() {
  const ALV_ITEMS = [
    ...
    { video:'https://www.youtube.com/embed/adPGVR59ie4?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/adPGVR59ie4/hqdefault.jpg', title:"Hariharanâ€™s 5-Year Journey with Testleaf: From Selenium to Lifelong Learning" },
    { video:'https://www.youtube.com/embed/uKBVuq7gcvs?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/uKBVuq7gcvs/hqdefault.jpg', title:"How Testleaf Transformed My 8-Year Testing Career: Karthikeyenâ€™s TCS Success" },
    { video:'https://www.youtube.com/embed/tL-HTxUmZq8?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/tL-HTxUmZq8/hqdefault.jpg', title:"Muraliâ€™s Rise: How Testleaf Accelerated His Career During the Pandemic" },
    ...
    { video:'https://www.youtube.com/embed/8Nn_d6kT5h4?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/8Nn_d6kT5h4/hqdefault.jpg', title:'Nagarajanâ€™s 5-Year Journey: Growing with Testleaf and Gaining Knowledge' },
    { video:'https://www.youtube.com/embed/pZnC7K5BtpE?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/pZnC7K5BtpE/hqdefault.jpg', title:'Pradeepâ€™s Leap: 150% Salary Hike After Upskilling with Testleaf' },
    { video:'https://www.youtube.com/embed/rO7DaftQukM?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/rO7DaftQukM/hqdefault.jpg', title:'From Technical Weakness to QA Manager: Prasannaâ€™s Success with Testleaf' },
    { video:'https://www.youtube.com/embed/kagrmlUPKDs?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/kagrmlUPKDs/hqdefault.jpg', title:'Raghuuthamanâ€™s 7-Year Journey: 3X Salary Growth with Testleaf' },
    { video:'https://www.youtube.com/embed/2soosHipS6U?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/2soosHipS6U/hqdefault.jpg', title:'Shankarâ€™s Breakthrough: Cracking 2 Product-Based Companies with Testleaf' },
    { video:'https://www.youtube.com/embed/0CD9GPcSnh0?rel=0&modestbranding=1', thumb:'https://img.youtube.com/vi/0CD9GPcSnh0/hqdefault.jpg', title:'Suganthiâ€™s Success: A Decade in the Industry, 5 Years of Growth with Testleaf'}
  ];
  ...
  let loopReady = false;
  const SPEED_PX_PER_FRAME = 0.6; // tune 0.4â€“1.0 for slower/faster smoothness
...
// ends
  ...
  // ðŸ”§ Don't use scrollIntoView (it moves the page). Scroll the track instead.
  function toIndex(i){
  ...
  // Start/stop on viewport visibility so it won't jump when youâ€™re far down the page
...
document.getElementById('tlw-more').addEventListener('click', function () {
      ...
      this.innerHTML = isOpen ? 'Show more <span class="tlw-chevron">â–¾</span>' : 'Show less <span class="tlw-chevron">â–¾</span>';
    });
...
(() => {
  ...
  // Init from URL (?cat=Automation or #cat=Automation) â€” mobile only
...
(function () {
  ...
  console.log('âœ… Sticky header initialized (hover mega menu).');
})();
